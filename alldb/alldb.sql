...
-- Dumping structure for table pospoint.camp
...
-- Dumping data for table pospoint.camp: 0 rows
/*!40000 ALTER TABLE `camp` DISABLE KEYS */;
/*!40000 ALTER TABLE `camp` ENABLE KEYS */;

-- Dumping structure for table pospoint.client
...
-- Dumping data for table pospoint.client: 1 rows
...
-- Dumping structure for table pospoint.contact
...
-- Dumping data for table pospoint.contact: ~6 rows (approximately)
...
-- Dumping structure for table pospoint.crm_user
CREATE TABLE IF NOT EXISTS `crm_user` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `package` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ...
  `paymentNo` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `date_reg` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=latin1;

-- Dumping data for table pospoint.crm_user: 13 rows
...
-- Dumping structure for table pospoint.lead
...
-- Dumping data for table pospoint.lead: ~80 rows (approximately)
...
-- Dumping structure for table pospoint.leads
CREATE TABLE IF NOT EXISTS `leads` (
  ...
  `phone_home` varchar(100) DEFAULT NULL,
  `phone_mobile` varchar(100) DEFAULT NULL,
  `business_phone` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `alt_address_state` varchar(100) DEFAULT NULL,
  `alt_address_postalcode` varchar(20) DEFAULT NULL,
  `business_industry` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `assistant` varchar(75) DEFAULT NULL,
  `assistant_phone` varchar(100) DEFAULT NULL,
  `converted` tinyint(1) DEFAULT '0',
  `refered_by` varchar(100) DEFAULT NULL,
  `lead_source` varchar(100) DEFAULT NULL,
  `lead_score` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  `lead_status` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `status_description` text,
  `reports_to_id` char(36) DEFAULT NULL,
  `account_name` varchar(255) DEFAULT NULL,
  `account_description` text,
...
-- Dumping data for table pospoint.leads: ~2 rows (approximately)
...
-- Dumping structure for table pospoint.order_item_table
...
-- Dumping data for table pospoint.order_item_table: ~0 rows (approximately)
/*!40000 ALTER TABLE `order_item_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_item_table` ENABLE KEYS */;

-- Dumping structure for table pospoint.order_table
CREATE TABLE IF NOT EXISTS `order_table` (
  `order_id` int NOT NULL AUTO_INCREMENT,
  `order_number` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `order_table` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `order_waiter` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `order_cashier` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `order_status` enum('In Process','Completed') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table pospoint.order_table: ~0 rows (approximately)
/*!40000 ALTER TABLE `order_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_table` ENABLE KEYS */;

-- Dumping structure for table pospoint.order_tax_table
CREATE TABLE IF NOT EXISTS `order_tax_table` (
  `order_tax_table_id` int NOT NULL AUTO_INCREMENT,
  `order_id` int NOT NULL,
  `order_tax_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `order_tax_percentage` decimal(4,2) NOT NULL,
  `order_tax_amount` decimal(12,2) NOT NULL,
  PRIMARY KEY (`order_tax_table_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table pospoint.order_tax_table: ~0 rows (approximately)
/*!40000 ALTER TABLE `order_tax_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_tax_table` ENABLE KEYS */;

-- Dumping structure for table pospoint.people
...
-- Dumping data for table pospoint.people: 5 rows
...
-- Dumping structure for table pospoint.product_category_table
...
-- Dumping data for table pospoint.product_category_table: ~0 rows (approximately)
/*!40000 ALTER TABLE `product_category_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `product_category_table` ENABLE KEYS */;

-- Dumping structure for table pospoint.product_table
CREATE TABLE IF NOT EXISTS `product_table` (
  `product_id` int NOT NULL AUTO_INCREMENT,
  `category_name` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `product_name` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `product_price` decimal(10,2) NOT NULL,
  `product_status` enum('Enable','Disable') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table pospoint.product_table: ~0 rows (approximately)
/*!40000 ALTER TABLE `product_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `product_table` ENABLE KEYS */;

-- Dumping structure for table pospoint.restaurant_table
CREATE TABLE IF NOT EXISTS `restaurant_table` (
  `restaurant_id` int NOT NULL AUTO_INCREMENT,
  `restaurant_name` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `restaurant_tag_line` varchar(300) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `restaurant_address` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `restaurant_contact_no` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `restaurant_email` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `restaurant_currency` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `restaurant_timezone` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `restaurant_logo` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`restaurant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table pospoint.restaurant_table: ~0 rows (approximately)
/*!40000 ALTER TABLE `restaurant_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `restaurant_table` ENABLE KEYS */;

-- Dumping structure for table pospoint.table_data
CREATE TABLE IF NOT EXISTS `table_data` (
  `table_id` int NOT NULL AUTO_INCREMENT,
  `table_name` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `table_capacity` int NOT NULL,
  `table_status` enum('Enable','Disable') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`table_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table pospoint.table_data: ~0 rows (approximately)
/*!40000 ALTER TABLE `table_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `table_data` ENABLE KEYS */;

-- Dumping structure for table pospoint.tax_table
CREATE TABLE IF NOT EXISTS `tax_table` (
  `tax_id` int NOT NULL AUTO_INCREMENT,
  `tax_name` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `tax_percentage` decimal(4,2) NOT NULL,
  `tax_status` enum('Enable','Disable') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`tax_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table pospoint.tax_table: ~0 rows (approximately)
...
-- Dumping structure for table pospoint.userlog
...
-- Dumping data for table pospoint.userlog: ~0 rows (approximately)
/*!40000 ALTER TABLE `userlog` DISABLE KEYS */;
/*!40000 ALTER TABLE `userlog` ENABLE KEYS */;

-- Dumping structure for table pospoint.user_table
CREATE TABLE IF NOT EXISTS `user_table` (
  `user_id` int NOT NULL AUTO_INCREMENT,
  `user_name` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `user_contact_no` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `user_type` enum('Master','Waiter','Cashier') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `user_status` enum('Enable','Disable') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `user_created_on` datetime NOT NULL,
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table pospoint.user_table: ~0 rows (approximately)
