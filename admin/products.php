...
//$count2 = count($_POST["menu2"]);
//Getting post values
$menu1=$_POST["menu1"];	
$menu1_price=$_POST["menu1_price"];	
/*
$menu2=$_POST["menu2"];	
$menu2_price=$_POST["menu2_price"];	
*/
...
if($count > 1)
{
	for($i=0; $i<$count; $i++)
	{
			...
			if(trim($_POST["menu1"][$i] != ''))
			{
				...
				//$sql .="INSERT INTO products(main_menu,menu1,menu1_price) VALUES('$main_menu','$menu2[$i]','$menu2_price[$i]')";
		       /*
			    $sql ="INSERT INTO products(main_menu,name,price) VALUES('$main_menu','$menu1[$i]','$menu1_price[$i]');";
				$sql .="INSERT INTO products(main_menu,name,price) VALUES('$main_menu','$menu2[$i]','$menu2_price[$i]')";
