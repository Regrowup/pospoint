...
<head>
  ...
  <base href="/management/en-US/">  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"/>
  ...
  <link rel="apple-touch-icon-precomposed" sizes="76x76" href="assets/img/favicon/favicon-76.png">
  ...
  <link rel="shortcut" href="assets/img/favicon/favicon.ico" type="image/x-icon">

  <meta name="apple-mobile-web-ls-title" content="Restaurant Manager">

  <link href="https://fonts.googleapis.com/css?family=Lato:400,300,700,900,100&subset=latin-ext" rel="stylesheet" type="text/css">
  <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" />
  <script src="localeselect/exports.js?v=6.8.4"></script>
  <script src="localeselect/locale.js?v=6.8.4"></script>
  <script>
    // needed as long as we will support older browsers (eg: Safari <= 9.x)
    var script = document.createElement('script');
    script.setAttribute('src', 'https://cdn.polyfill.io/v2/polyfill.min.js?features=Intl.~locale.' + LocaleUtils.getLocale()+'&ua='+navigator.userAgent+'&unknown=polyfill');
    document.head.appendChild(script);
  </script>
<link rel="stylesheet" href="styles.827ccd523f9daa54b6bf.css"></head>
<body>
  ...
  <script type="text/javascript">
    ...
    var production = /(^apc)|(^aps)|(^euc)|(^euw)|(^nae)|(^naw)/;
    var development = /(^backend)|(^frontend)|(^ghent)|(^ios)|(^qa)/;
    var staging = /(^staging)|(^demo-internal)/;
    var posios = /.posios.com$/;

    var licenseKey = '';
    var applicationId = '';
    var track = false;

    if (production.test(host) && posios.test(host)) {
      if (host.indexOf('-web') > 0) {
        applicationId = '73595052';
      } else {
        applicationId = '72170883';
      }
      licenseKey = 'b5546ed04d';
      var track = true;
    } else if (staging.test(host) && posios.test(host)) {
      applicationId = '72170829';
      licenseKey = 'b1c79fb0ec';
      var track = true;
    } else if (host === 'localhost' || host === '0.0.0.0' || development.test(host)) {
      applicationId = '72170613';
      licenseKey = '2e2a74ce52';
      var track = true;
    }
  ...
  <script type="text/javascript">
    window.zESettings = {
      webWidget: {
        chat: {
          tags: ['resto_chat', 'resto_chat_route'],
          departments: {
            select: 'Restaurant'
          }
        }
  ...
  <script id="ze-snippet" src="https://static.zdassets.com/ekr/snippet.js?key=68e3d8c3-6111-4cb4-8d4e-de3def40787b"></script>
  ...
  <ls-root>
    ...
    <svg width="74px" height="109px" viewBox="53 36 74 109" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
     <defs>
      </defs>
      <path d="M90.3915,36 L95.4215,44.711 C96.4545,46.503 96.4545,48.729 95.4215,50.519 L65.5685,102.227 L79.6575,126.623 C81.8655,130.447 85.9635,132.824 90.3845,132.824 C94.8055,132.824 98.9225,130.447 101.1315,126.624 L115.2185,102.227 L111.4125,95.639 L95.4245,123.334 C94.3905,125.127 92.4415,126.236 90.3905,126.236 C88.3395,126.236 86.3985,125.127 85.3655,123.334 L73.1825,102.225 L100.9025,54.203 L105.9315,62.914 C106.9655,64.708 106.9655,66.933 105.9315,68.724 L86.5885,102.227 L90.3925,108.819 L111.4125,72.407 L125.2015,96.287 C127.3145,99.953 127.3145,104.506 125.2015,108.167 L111.1905,132.433 C109.0425,136.152 102.4105,144.443 90.3725,144.443 C78.3355,144.443 71.7435,136.152 69.5975,132.433 L55.5855,108.171 C53.4715,104.503 53.4715,99.952 55.5855,96.291 L90.3915,36" id="Fill-90" stroke="0" fill-rule="evenodd" fill="#ED5153" />
    </svg>
  </ls-root>
<script type="text/javascript" src="runtime.a819593e91af232dd460.js"></script><script type="text/javascript" src="polyfills.92a4c0cb5304fbcfe30c.js"></script><script type="text/javascript" src="scripts.a1c5e8f98ce49df41649.js"></script><script type="text/javascript" src="vendor.dec98364b48137053205.js"></script><script type="text/javascript" src="main.dece2e09e2566da40854.js"></script></body>
</html>
